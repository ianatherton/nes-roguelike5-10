...
# Script to build the Arkista-style UI demo ROM

# Ensure output directories exist
mkdir -p build
mkdir -p roms

# Create the CHR data file
echo "Creating CHR data file..."
cat > build/arkista_chr_data.s << EOF
; Include the CHR data for our demo
.segment "CHARS"
...
cat > build/arkista_header.s << EOF
.segment "HEADER"
.byte "NES", \$1a
...
ca65 -t nes src/arkista_ui_demo.s -o build/arkista_ui_demo.o
ca65 -t nes build/arkista_header.s -o build/arkista_header.o
ca65 -t nes build/arkista_chr_data.s -o build/arkista_chr_data.o

# Link everything together
echo "Linking..."
ld65 -o roms/arkista_ui_demo.nes \
    build/arkista_ui_demo.o \
    build/arkista_header.o \
    build/arkista_chr_data.o \
    -C simple-nes.cfg

echo "Build complete! ROM is at roms/arkista_ui_demo.nes"
